describe("About Objects", function () {
    ...
    var megalomaniac = {
      ...
      battleCry: function (noOfBrains) {
        return "They are " + this.henchman + " and the" +
          Array(noOfBrains + 1).join(" " + this.mastermind); //opp of split() of java world
      }
    };
  ...
  describe("'in' keyword", function () {
    ...
    it("should have the bomb", function () {
      ...
      var hasBomb = "theBomb" in megalomaniac; // checks existence

      expect(hasBomb).toBe(true);
      expect("mastermind" in megalomaniac).toBe(true);
      expect("henchwoman" in megalomaniac).toBe(true);
    });
